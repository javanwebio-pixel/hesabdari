                    ...
                    <table className="w-full text-sm text-right">
                        ...
                        <tfoot className="font-bold bg-gray-50 dark:bg-gray-700">
                             <tr>
                                ...
                                <td className="px-4 py-2 font-mono">{chartData.reduce((s, r) => s + r.budget, 0).toLocaleString('fa-IR')}</td>
                                <td className="px-4 py-2 font-mono">{chartData.reduce((s, r) => s + r.actual, 0).toLocaleString('fa-IR')}</td>
                                <td className="px-4 py-2 font-mono">{chartData.reduce((s, r) => s + r.variance, 0).toLocaleString('fa-IR')}</td>
